...
const Battle = {
     ...
     */
    getThrowingEnchantments: function (immediate) {
        const enchantments = []
     ...
     */
    hasThrowingEnchantment: function (immediate, enchantmentId) {
     ...
     */
    getThrowingEnchantmentLevel: function (immediate, enchantmentId) {
        const enchantments = getThrowingEnchantments(immediate)
        for (let i = 0; i < enchantments.length; i++) {
            if (enchantments[i].id === enchantmentId) {
     ...
     */
    getItemAttackDamageFromTooltip: function (player, itemStack) {
     ...
     * @returns 
     */
    getItemAttackDamage: function (player, itemStack) {
        const {
            server,
            level,
        } = player
