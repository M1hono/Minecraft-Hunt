...
WeaponThrower.prototype = {
    ...
    _throwFromSlot: function(slot, direction) {
        ...
        if (this.throwReverse ? slot < 0 : slot >= this.player.inventory.containerSize) return;
    ...
    _processNextSlot: function(slot, direction) {
        if (this.throwCount < this.maxThrowCount) {
            ...
            this.server.scheduleInTicks(this.throwDelay, () => this._throwFromSlot(nextSlot, direction));
        }
    },
